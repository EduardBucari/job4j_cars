...
public class AddAuto {
    ...
    public void addCarBodies() {
        CarBodyRepository.instOf().saveCarBodies(CarBody.of("Седан"));
        CarBodyRepository.instOf().saveCarBodies(CarBody.of("Хэтчбек"));
        CarBodyRepository.instOf().saveCarBodies(CarBody.of("Универсал"));
        CarBodyRepository.instOf().saveCarBodies(CarBody.of("Внедорожник"));
        CarBodyRepository.instOf().saveCarBodies(CarBody.of("Купе"));
    }
